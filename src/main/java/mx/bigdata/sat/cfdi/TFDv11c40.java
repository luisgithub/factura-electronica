...
import mx.bigdata.sat.cfdi.v40.schema.TimbreFiscalDigital;
...
public final class TFDv11c40 {
    ...
    private static JAXBContext createContext() {
        if(CONTEXT==null) {
            try {
                return JAXBContext.newInstance("mx.bigdata.sat.cfdi.v40.schema");
    ...
    public TFDv11c40(CFDI cfd, X509Certificate cert, String PAC, String leyenda) throws Exception {
        this(cfd, cert, UUID.randomUUID(), new Date(), PAC, leyenda);
    }

    TFDv11c40(CFDI cfd, X509Certificate cert, UUID uuid, Date date, String PAC, String leyenda) throws Exception {
        this.cert = cert;
    ...
    private Element marshalTFD() throws Exception {
        ...
        Marshaller m = CONTEXT.createMarshaller();
        m.setProperty("com.sun.xml.bind.namespacePrefixMapper", new NamespacePrefixMapperImpl(CFDv40.PREFIXES));
