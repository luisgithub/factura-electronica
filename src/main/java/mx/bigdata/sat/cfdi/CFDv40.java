...
import mx.bigdata.sat.cfdi.v40.schema.Comprobante;
import mx.bigdata.sat.cfdi.v40.schema.ObjectFactory;
...
public final class CFDv40 implements CFDI {

    private static final String XSLT = "/xslt/cadenaoriginal_4_0.xslt";

    private static final String[] XSD = new String[]{
            "/xsd/common/tdCFDI.xsd",
            "/xsd/common/catCFDI.xsd",
            "/xsd/v40/cfdv40.xsd",
            "/xsd/v40/TimbreFiscalDigitalv11.xsd",
...
//            "/xsd/common/Pagos/Pagos10.xsd",
    ...
    private static final String BASE_CONTEXT = "mx.bigdata.sat.cfdi.v40.schema";
    ...
    public static final ImmutableMap<String, String> PREFIXES = ImmutableMap.of("http://www.w3.org/2001/XMLSchema-instance", "xsi", "http://www.sat.gob.mx/cfd/4", "cfdi", "http://www.sat.gob.mx/TimbreFiscalDigital", "tfd");
            ...
            for (Comprobante.Complemento o : document.getComplemento()) {
                for (Object c : o.getAny()) {
                    if (c instanceof mx.bigdata.sat.cfdi.v33.schema.TimbreFiscalDigital) {
                        ...
                        if (!schema.contains("http://www.sat.gob.mx/Pagos http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos20.xsd")) {
                            schema += " http://www.sat.gob.mx/Pagos http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos20.xsd";
                        }
                    } else {
    ...
    public static final class CFDv40ComprobanteBase implements ComprobanteBase {

        private final Comprobante document;

        public CFDv40ComprobanteBase(Comprobante document) {
